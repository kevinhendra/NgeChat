...
public class ChatActivity extends AppCompatActivity {
    ...
    {
        RootKev.child("Users").child(messageSenderID)
    ...
    protected void onStart() {
        super.onStart();
        RootKev.child("Messages").child(messageSenderID).child(messageReceiverID)
    ...
    private void SendMessage(){
        ...
        if(TextUtils.isEmpty(messageText))
        {
            ...
            DatabaseReference userMessageKeyRef = RootKev.child("Messages")
            ...
            RootKev.updateChildren(messageBodyDetails).addOnCompleteListener(new OnCompleteListener() {
                @Override
